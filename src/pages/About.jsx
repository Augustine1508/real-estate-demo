    ...
    <div className="w-full">
      ...
      <section className="py-12 px-5 max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-700 leading-relaxed text-[17px]">
          This demo website was created to show real estate companies how a
          modern and professional website can transform their online presence
          <br />
          Many real estate businesses in Port Harcourt rely only on WhatsApp and
          social media, missing out on clients who want a clean and reliable
          place to browse properties.
        </p>
      </section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          <div className="bg-white p-6 rounded-xl shadow text-center">
            ...
            <p className="text-gray-600 text-[15px]">
              We build long-lasting relationships through honesty and
              transparency.
            </p>
          </div>
      ...
      <section className="py-14 px-6 bg-blue-600 text-center text-white">
        ...
        <p className="mt-2 text-lg">
          Our agents are always ready to guide you.
        </p>
